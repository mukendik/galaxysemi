...
# USE_GLUT = yes
CONFIG *= debug_and_release qt opengl warn_on shared thread create_prl rtti

include($(DEVDIR)/galaxy_common.pri)

DESTDIR = $(DEVDIR)/other_libraries/libqglviewer/lib/$$OSFOLDER
TEMPLATE = lib
TARGET = $$gexTargetName(qglviewer)
VERSION = 2.4.0
CONFIG *= qt opengl shared thread create_prl rtti no_keywords
