...
struct SOCKADDR_IN {
  ...
  //! \brief address must IPv4 format: a.b.c.d
...
//    ok = (ADDR.sin_addr.S_un.S_addr != INADDR_NONE);    
  ...
  */
  ...
  /* // Moved in cpp to prevent link isssues on Windows
  {
...
void initNetworking();
// Send a message through syslog protocol. Severity between 0 and 7. Message of 1000 chars max.
int Syslog(unsigned severity, char* message);
