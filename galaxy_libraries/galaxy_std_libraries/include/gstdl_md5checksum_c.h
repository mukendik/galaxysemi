...
#define MD5_FILE_ERROR_ACCES	3 
#define MD5_FILE_ERROR_EXIST	4
#define MD5_FILE_ERROR_CLOSE	5

#define MD5_RESULT_SIZE			33	/* Size of the result + 1 for the end of string '\0' */
...
#if defined(_MD5FileModule_)
#define _MD5_EXPORT
#else
#define _MD5_EXPORT	extern
#endif

#if !defined(__cplusplus) && !defined(ANSI)

	_MD5_EXPORT	int GetMD5Buffer();
	_MD5_EXPORT	int GetMD5File();
	_MD5_EXPORT	int GetMD5();
