...
Stdf::Stdf()
{
    ...
    // default deciphering mode for site number
    m_SiteNumberDecipheringMode = no_deciphering;
}
...
// return :	false if not
///////////////////////////////////////////////////////////
bool Stdf::IsCompatible(const char *szStdfFile)
{
...
char* Stdf::sEnglishDayNames[]={
    (char*)"Mon", (char*)"Tue", (char*)"Wed", (char*)"Thu", (char*)"Fri", (char*)"Sat", (char*)"Sun" };

char* Stdf::sEnglishMonthNames[]={
    (char*)"Jan", (char*)"Feb", (char*)"Mar", (char*)"Apr", (char*)"May", (char*)"Jun", (char*)"Jul", (char*)"Aug",
    (char*)"Sep", (char*)"Oct", (char*)"Nov", (char*)"Dec" };

char* Stdf::GetMonthName(const int &lMonthIndex)
{
    if (lMonthIndex<0 || lMonthIndex>11)
        return 0;
    return sEnglishMonthNames[lMonthIndex];
}

char* Stdf::GetDaysOfWeekString(const int &lDaysIndex)
{
    if (lDaysIndex<0 || lDaysIndex>6)
        return 0;
    return sEnglishDayNames[lDaysIndex];
}

int Stdf::GetStaticStdfVersion()
{
    return sStdfVersion;
}

int Stdf::GetCPUType(const std::string &lSTDFFilename)
{
    GS::StdLib::Stdf lSTDFFile;

    int lCPUType    = 1;
    int lStatus     = lSTDFFile.Open(lSTDFFilename.c_str()/*.toLatin1().constData()*/, STDF_READ, 1000000L);

    if(lStatus == GS::StdLib::Stdf::NoError)
    {
        lCPUType = lSTDFFile.GetStdfCpuType();
        lSTDFFile.Close();
    }
...
///////////////////////////////////////////////////////////
int	Stdf::Open(const char *szStdfFile,int iAccessMode,long lCacheSizeValue,bool bValidityCheck/*=true*/)
{
    int		iStatus;
...
///////////////////////////////////////////////////////////
int Stdf::IsStdfFormat(const char *szStdfFile, bool *pbValidFileStart)
{
    int					nStatus;
    GS::StdLib::StdfRecordReadInfo	ReadInfo;
    bool				bValidRecord;
...
///////////////////////////////////////////////////////////
bool Stdf::RepairStdfFile(const char *szStdfFile, const char *szStdfFile_Repaired, int nCpuType)
{
    int					nStatus;
    GS::StdLib::StdfRecordReadInfo	ReadInfo;
    bool				bValidRecord;
...
// return :	NoError or error code
///////////////////////////////////////////////////////////
long	Stdf::GetFileSize(const char *szStdfFile)
{
    FILE	*stream;
    long	lSize;
...
// return :	record#
///////////////////////////////////////////////////////////
long	Stdf::GetReadRecordNumber(void)
{
    return lRecRead;
}
...
///////////////////////////////////////////////////////////
long	Stdf::SmartFread(BYTE **ptRxBuffer, int iBlockSize)
{
    if(hReadStdfCache == NULL)
    {
...
///////////////////////////////////////////////////////////
long Stdf::GetReadRecordPos(void)
{
    return nReadOffset;
}
...
// return :	NoError or error code
///////////////////////////////////////////////////////////
int	 Stdf::SetReadRecordPos(long nNewReadOffset)
{
...
// return :	NoError or error code
///////////////////////////////////////////////////////////
int	Stdf::LoadRecord(LPStdfRecordReadInfo pRecordReadInfo)
{
...
///////////////////////////////////////////////////////////
bool Stdf::IsValidStdfRecordType(GS::StdLib::StdfRecordReadInfo *StdfRecordHeader)
{
    switch(StdfRecordHeader->iRecordType)
    {
        case 0://	Information about the STDF file
            switch(StdfRecordHeader->iRecordSubType)
            {
                ...
                case 30://  Version Update Record (VUR)		(V4 2007)
        ...
        case 1://	Data collected on a per lot basis
            switch(StdfRecordHeader->iRecordSubType)
            {
                ...
                case 90://	Pattern Sequence Record (PSR)	(V4 2007)
                case 91://	Name Map Record (NMR)			(V4 2007)
                case 92://	Cell Name Record (CNR)			(V4 2007)
                case 93://	Scan Structure Record (SSR)		(V4 2007)
                case 94://	Chain Description Record (CDR)	(V4 2007)
                    return true;	// Valid record
            }
            break;
        ...
        case 15://	Data collected per test execution
            switch(StdfRecordHeader->iRecordSubType)
            {
                ...
                case 30://	Scan Test Record (STR)			(V4 2007)
                    return true;	// Valid record
            }
            break;
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::OverwriteReadByte(BYTE cByte)
{
    if(nReadOffset >= nReadBufferSize)
        return EndOfBuffer;
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::ReadString(char *szString)
{
  ...
  *szString = 0;
  ...
  bStringLength = hStdfMem[nReadOffset];
  nReadOffset++;
  bStringLength &= 0xff;
  for(i=0;i<bStringLength;i++){
      ...
      szString[i] = hStdfMem[nReadOffset];
      nReadOffset++;
  }
...
int	Stdf::ReadSNString(char *szString){
    int	bStringLength;
    unsigned int i;
...
int	Stdf::ReadCFString(int iSize,char *szString){
    int i;
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::ReadBitField(BYTE *pbLength, char *pBitField)
{
  BYTE	i;
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::ReadDBitField(unsigned int *pwLength, char *pBitField)
{
  unsigned int	i;
  int			iData;
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::OverwriteReadWord(WORD wData)
{
  if(nReadOffset >= nReadBufferSize)
     return EndOfBuffer;
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::ReadDword(long *ptDword)
{
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::OverwriteReadDword(DWORD dwData)
{
  if(nReadOffset >= nReadBufferSize)
     return EndOfBuffer;
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::ReadFloat(float *ptFloat)
{
    float	fData;
    BYTE	*bBuf2;
    BYTE	ptData[4];
  ...
  if(nReadOffset >= nReadBufferSize)
    ...
    for (iIndex=0; iIndex < 4; iIndex++) {
        ...
        ptData[iIndex] = hStdfMem[nReadOffset];
        nReadOffset++;
    }
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::ReadFloat(float *ptFloat, bool *pbIsNAN)
{
    float	fData;
    BYTE	*bBuf2;
    BYTE	ptData[4];
...
// return :	NoError or EndOfBuffer
///////////////////////////////////////////////////////////
int	Stdf::ReadDouble(double *ptDouble)
{
    double	lfData;
    BYTE	*bBuf8;
    BYTE	ptData[8];
...
///////////////////////////////////////////////////////////
void	Stdf::SetStdfCpuType(int iWriteCpuType)
{
...
// Get CPU type
///////////////////////////////////////////////////////////
BYTE	Stdf::GetComputerCpuType(void)
{
#ifdef __sparc__
...
///////////////////////////////////////////////////////////
int	Stdf::WriteHeader(LPStdfRecordReadInfo pRecordReadInfo)
{
    // Check if file opened.
    if(hStdf == NULL)
        return FileClosed;
...
///////////////////////////////////////////////////////////
int	Stdf::WriteRecord(LPStdfRecordReadInfo pclStdfRecordReadInfo, Stdf *pclStdfSource)
{
...
///////////////////////////////////////////////////////////
int	Stdf::WriteDword(DWORD dwData)
{
    LPSTR	ptData;
...
///////////////////////////////////////////////////////////
int	Stdf::WriteWordOffset(WORD wData, BYTE *hBuffer, int nBufferOffset, bool bWriteSameCpu)
{
    LPSTR	ptData;
...
// return :	READ offset in record, 0 on error
///////////////////////////////////////////////////////////
long Stdf::GetWriteRecordPos(void)
{
    return nWriteOffset;
}
...
// return :	NoError or error code
///////////////////////////////////////////////////////////
int	 Stdf::SetWriteRecordPos(long nNewWriteOffset)
{
  // Checks if new offset is valid (not over buffer size)
...
///////////////////////////////////////////////////////////
int	Stdf::WriteFloat(float fData)
{
    BYTE	*ptData;
...
///////////////////////////////////////////////////////////
// Copy in stdf buffer a 8 bytes float number.
///////////////////////////////////////////////////////////
int	Stdf::WriteDouble(double lfData)
{
    BYTE	*ptData;
...
///////////////////////////////////////////////////////////
int	Stdf::WriteString(const char * szString)
{
    BYTE			bLength;
    const char *	ptChar;
...
int	Stdf::WriteSNString(const char * szString){
...
int	Stdf::WriteCFString(const char * szString){
...
///////////////////////////////////////////////////////////
int	Stdf::WriteBitField(BYTE bLength, char *pBitField)
{
    char *ptChar;
...
///////////////////////////////////////////////////////////
int	Stdf::WriteDBitField(unsigned int wLength, char *pBitField)
{
    char *ptChar;
    ...
    WriteWord((WORD)(wLength*8));				// String length
    ptChar = pBitField;
...
///////////////////////////////////////////////////////////
int	Stdf::WriteFixedString(LPSTR szString,int iFixedLength)
{
    BYTE	bLength;
    LPSTR	ptChar;
...
///////////////////////////////////////////////////////////
int	Stdf::DumpRecord(LPStdfRecordReadInfo pRecordReadInfo,Stdf *pStdfRecord,bool bFullRecord/*=false*/)
{
    if(bFullRecord)
...
int	Stdf::ReadQword( unsigned long long *pullQWData){
...
int	Stdf::WriteQWord(unsigned long long ullData){
