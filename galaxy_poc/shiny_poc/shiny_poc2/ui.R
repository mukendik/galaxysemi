...
library(DBI)
library(RMySQL)
library(googleCharts) # installed through : devtools::install_github("jcheng5/googleCharts")
...
shinyUI(  
  fluidPage(
    ...
    googleChartsInit(),
    h2("Interactive Mode Using Google Charts"),
    googleBarChart("chart", width="100%", height="100%",
                   options = list(fontName = "Source Sans Pro", fontSize = 13, explorer = list(),
