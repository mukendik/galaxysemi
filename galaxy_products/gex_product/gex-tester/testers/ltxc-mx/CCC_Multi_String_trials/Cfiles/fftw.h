...
/* $Id: fftw.h,v 1.1.1.1 2007/07/30 19:59:20 rjn Exp $ */

#if ( defined( FFTW_ENABLE_FLOAT) && !defined( SP_FFTW_H ) ) || (!defined( FFTW_ENABLE_FLOAT) && !defined( DP_FFTW_H ) )
...
#    define FFTW_NS  spFFTW
#  else
#    define FFTW_NS  dpFFTW
#  endif
#endif
