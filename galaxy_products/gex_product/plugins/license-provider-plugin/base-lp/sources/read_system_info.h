...
//  #ifdef QT_DLL
    ...
    #include <windows.h>
    #include <QString>
    #define clString QString
//  #else
//	// Windows MFC project
//    #include <stdafx.h>
//	#define clString CString
//  #endif
  #include <regstr.h>
  #include <QSysInfo>
#endif
...
class LICENSE_PROVIDERSHARED_EXPORT ReadSystemInfo
{
public:
	ReadSystemInfo(void);
...
#endif
	clString strPlatform;			// Platform type: [PC-Windows], [Sun-Solaris], [HP-UX] or [Linux]
	clString strHostName;			// Computer name
	clString strAccountName;			// Login name
	clString strNetworkBoardID;		// Network Adaptor MAC address
	clString strNetworkBoardsIDs;	// List of Ethernet MAC addresses with ';' separator
	clString strDiskID;				// PC: String list of Disk serial numbers
	clString strHostID;				// Unix: Host ID, PC: computed from disksSerialNumbers.
