// gexdb_plugin_galaxy_admin_b22.cpp: implementation of the administration functions of GexDbPlugin_Galaxy class.
// B21->B22 upgrade
// ----------------------------------------------------------------------------------------------------------
// Copyright Galaxy
...
////////////////////////////////////////////////////////////////////////////////////
bool GexDbPlugin_Galaxy::UpdateDb_B21_to_B22()
{
    ...
    if (!AddDbUpdateSteps(eUpdateDb)) goto updatedb_b21_to_b22_error_noset;
    ...
    {
        if (!AddDbUpdateSteps(eUpdateConsTriggers|eUpdateConsTables|eUpdateConsProcedures)) goto updatedb_b21_to_b22_error_noset;
        if (!RemoveDbUpdateSteps(eUpdateConsOld)) goto updatedb_b21_to_b22_error_noset;
    }
    ...
    strQuery += " DB_VERSION_NAME='"+GetDbName(GEXDB_DB_VERSION_NAME_B22)+"'";
    strQuery += ",DB_VERSION_NB=" + QString::number(GEXDB_DB_VERSION_NB_B22);
    strQuery += ",DB_VERSION_BUILD=" + QString::number(GEXDB_DB_VERSION_BUILD_B22);
    if(!clQuery.Execute(strQuery)) goto updatedb_b21_to_b22_error;
    ...
    if (!AddDbUpdateSteps(eUpdateConsProcedures)) goto updatedb_b21_to_b22_error_noset;

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    IncrementProgress();

    // Update db_status to record the end
    if(!RemoveDbUpdateSteps(eUpdateDb)) goto updatedb_b21_to_b22_error;
