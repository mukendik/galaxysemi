...
, 'file_checksum' INTEGER CHECK ( 'file_checksum'>=0 )
...
(
'splitlot_id' INTEGER NOT NULL CHECK ( 'splitlot_id'>=0 ) DEFAULT '0'
, 'mptest_info_id' INTEGER NOT NULL CHECK ( 'mptest_info_id'>=0 ) DEFAULT '0'
, 'tnum' INTEGER NOT NULL CHECK ( 'tnum'>=0 ) DEFAULT '0'
...
(
'splitlot_id' INTEGER NOT NULL CHECK ( 'splitlot_id'>=0 ) DEFAULT '0'
, 'ptest_info_id' INTEGER NOT NULL CHECK ( 'ptest_info_id'>=0 ) DEFAULT '0'
, 'tnum' INTEGER NOT NULL CHECK ( 'tnum'>=0 ) DEFAULT '0'
, 'tname' VARCHAR ( 255 ) NOT NULL DEFAULT ''
, 'units' VARCHAR ( 255 ) NOT NULL DEFAULT ''
, 'flags' BINARY ( 1 ) NOT NULL DEFAULT '\\0'
