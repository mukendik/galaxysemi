...
INSERT INTO &GEXADMIN..GLOBAL_INFO VALUES('GEXDB V1.0 B7', 10, 7, 0);
...
CREATE TABLE &GEXADMIN..ET_SPLITLOT (
	...
	SYL_ID				NUMBER(10)		DEFAULT 0,
	SBL_ID				NUMBER(10)		DEFAULT 0,
...
CREATE INDEX &GEXADMIN..ET_RUN 
		ON &GEXADMIN..ET_RUN	(SPLITLOT_ID) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..WT_RUN 
		ON &GEXADMIN..WT_RUN	(SPLITLOT_ID) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..FT_RUN 
		ON &GEXADMIN..FT_RUN	(SPLITLOT_ID) LOCAL COMPRESS;
