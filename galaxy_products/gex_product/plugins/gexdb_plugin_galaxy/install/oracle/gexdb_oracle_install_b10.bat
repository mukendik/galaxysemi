...
SET GexDbInstallSql=gexdb_oracle_install_b10.sql
...
(sqlplus -L %OracleRoot% @%GexDbUninstallSql% %GexAdminName% %GexUserName%) >"%TempGalaxyFile%"
SET a=
...
(sqlplus -L %OracleRoot% @%GexDbInstallSql% %GexAdminName% %GexAdminPwd% %GexUserName% %GexUserPwd% %GexDataBaseLoggingMode%) >"%TempGalaxyFile%"
SET a=
...
@echo.
@echo      GexDb instance = %GexDataBaseInstance%
