...
INSERT INTO &GEXADMIN..global_info VALUES('GEXDB V2.00 B15 (Oracle)', 200, 15, 0);
...
CREATE TABLE &GEXADMIN..incremental_update (
  ...
  db_version_build  NUMBER(6)  NULL
) TABLESPACE &GEXADMIN. PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS;
...
CREATE INDEX &GEXADMIN..etdtr_splitlot ON &GEXADMIN..et_dtr (splitlot_id);
...
CREATE INDEX &GEXADMIN..etprodalarm_splitlot ON &GEXADMIN..et_prod_alarm (splitlot_id);
...
CREATE INDEX &GEXADMIN..etproducthbin_product_bin ON &GEXADMIN..et_product_hbin (product_name,bin_no);
...
CREATE INDEX &GEXADMIN..etproductsbin_product_bin ON &GEXADMIN..et_product_sbin (product_name,bin_no);
...
CREATE INDEX &GEXADMIN..etlot_lot ON &GEXADMIN..et_lot (lot_id);

CREATE INDEX &GEXADMIN..etlot_product_lot ON &GEXADMIN..et_lot (product_name,lot_id);
...
CREATE INDEX &GEXADMIN..etlothbin_lot ON &GEXADMIN..et_lot_hbin (lot_id);
...
CREATE INDEX &GEXADMIN..etlotsbin_lot ON &GEXADMIN..et_lot_sbin (lot_id);
...
CREATE INDEX &GEXADMIN..etsplitlot_lot ON &GEXADMIN..et_splitlot (lot_id) LOCAL COMPRESS;
CREATE INDEX &GEXADMIN..etsplitlot_startt ON &GEXADMIN..et_splitlot (start_t) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..etwaferinfo_lot_wafer ON &GEXADMIN..et_wafer_info (lot_id, wafer_id);
...
CREATE INDEX &GEXADMIN..etwaferhbin_lot_wafer ON &GEXADMIN..et_wafer_hbin (lot_id, wafer_id); 
...
CREATE INDEX &GEXADMIN..etwafersbin_lot_wafer ON &GEXADMIN..et_wafer_sbin (lot_id, wafer_id);
...
CREATE INDEX &GEXADMIN..ethbin_splitlot ON &GEXADMIN..et_hbin (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..etsbin_splitlot ON &GEXADMIN..et_sbin (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..etrun_splitlot ON &GEXADMIN..et_run (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..etptestinfo_splitlot_ptest ON &GEXADMIN..et_ptest_info (splitlot_id,ptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..etpteststats_splitlot_ptest ON &GEXADMIN..et_ptest_stats (splitlot_id,ptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..etptestresults_splitlot_ptest ON &GEXADMIN..et_ptest_results (splitlot_id, ptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtprodalarm_splitlot ON &GEXADMIN..wt_prod_alarm (splitlot_id);
...
CREATE INDEX &GEXADMIN..wtproducthbin_product_bin ON &GEXADMIN..wt_product_hbin (product_name, bin_no);
...
CREATE INDEX &GEXADMIN..wtproductsbin_product_bin ON &GEXADMIN..wt_product_sbin (product_name, bin_no);
...
CREATE INDEX &GEXADMIN..wtlot_lot ON &GEXADMIN..wt_lot (lot_id);
CREATE INDEX &GEXADMIN..wtlot_product_lot ON &GEXADMIN..wt_lot (product_name,lot_id);
...
CREATE INDEX &GEXADMIN..wtlothbin_lot ON &GEXADMIN..wt_lot_hbin (lot_id);
...
CREATE INDEX &GEXADMIN..wtlotsbin_lot ON &GEXADMIN..wt_lot_sbin (lot_id);
...
CREATE INDEX &GEXADMIN..wtsplitlot_lot ON &GEXADMIN..wt_splitlot (lot_id) LOCAL COMPRESS;
CREATE INDEX &GEXADMIN..wtsplitlot_startt ON &GEXADMIN..wt_splitlot (start_t) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtwaferinfo_wafer ON &GEXADMIN..wt_wafer_info (wafer_id);
CREATE INDEX &GEXADMIN..wtwaferinfo_lot_wafer ON &GEXADMIN..wt_wafer_info (lot_id, wafer_id);
--
...
CREATE INDEX &GEXADMIN..wtwaferhbin_lot_wafer ON &GEXADMIN..wt_wafer_hbin (lot_id, wafer_id); 
...
CREATE INDEX &GEXADMIN..wtwafersbin_lot_wafer ON &GEXADMIN..wt_wafer_sbin (lot_id, wafer_id);
...
CREATE INDEX &GEXADMIN..wtpartssamp_splitlot_site ON &GEXADMIN..wt_parts_stats_samples (splitlot_id, site_no) LOCAL COMPRESS; 
...
CREATE INDEX &GEXADMIN..wtpartssum_splitlot_site ON &GEXADMIN..wt_parts_stats_summary (splitlot_id, site_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wthbin_splitlot ON &GEXADMIN..wt_hbin (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wthbinsamp_splitlot_site_hbin ON &GEXADMIN..wt_hbin_stats_samples (splitlot_id, site_no, hbin_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wthbinsum_splitlot_site_hbin ON &GEXADMIN..wt_hbin_stats_summary (splitlot_id, site_no, hbin_no) LOCAL COMPRESS; 
...
CREATE INDEX &GEXADMIN..wtsbin_splitlot ON &GEXADMIN..wt_sbin (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtsbinsamp_splitlot_site_sbin ON &GEXADMIN..wt_sbin_stats_samples (splitlot_id, site_no, sbin_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtsbinsum_splitlot_site_sbin ON &GEXADMIN..wt_sbin_stats_summary (splitlot_id, site_no, sbin_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtrun_splitlot ON &GEXADMIN..WT_RUN (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtptestinfo_splitlot_ptest ON &GEXADMIN..wt_ptest_info (splitlot_id,ptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtptestlimits_splitlot_ptest ON &GEXADMIN..wt_ptest_limits (splitlot_id,ptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtptestresults_splitlot_ptest ON &GEXADMIN..wt_ptest_results (splitlot_id, ptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtptestsamp_splitlot_ptest ON &GEXADMIN..wt_ptest_stats_samples (splitlot_id, ptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtptestsum_splitlot_ptest ON &GEXADMIN..wt_ptest_stats_summary (splitlot_id, ptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtmptestinfo_splitlot_mptest ON &GEXADMIN..wt_mptest_info (splitlot_id,mptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtmptestlimits_splitlot_mptest ON &GEXADMIN..wt_mptest_limits (splitlot_id,mptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtmptestresults_splitlot_mptes ON &GEXADMIN..wt_mptest_results (splitlot_id, mptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtmptestsamp_splitlot_mptest ON &GEXADMIN..wt_mptest_stats_samples (splitlot_id, mptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtmptestsum_splitlot_mptest ON &GEXADMIN..wt_mptest_stats_summary (splitlot_id, mptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtdtr_splitlot ON &GEXADMIN..wt_dtr (splitlot_id);
...
CREATE INDEX &GEXADMIN..wtftestinfo_splitlot_ftest ON &GEXADMIN..wt_ftest_info (splitlot_id,ftest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..wtftestresults_splitlot_ftest ON &GEXADMIN..wt_ftest_results (splitlot_id, ftest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtftestsamp_splitlot_ftest ON &GEXADMIN..wt_ftest_stats_samples (splitlot_id, ftest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._wt_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..wtftestsum_splitlot_ftest ON &GEXADMIN..wt_ftest_stats_summary (splitlot_id, ftest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftdtr_splitlot ON &GEXADMIN..ft_dtr (splitlot_id);
...
CREATE INDEX &GEXADMIN..ftmultidietracking_fttl ON &GEXADMIN..ft_die_tracking (ft_tracking_lot_id);
CREATE INDEX &GEXADMIN..ftmultidietracking_wttl ON &GEXADMIN..ft_die_tracking (wt_tracking_lot_id);
...
CREATE INDEX &GEXADMIN..ftprodalarm_splitlot ON &GEXADMIN..ft_prod_alarm (splitlot_id);
...
CREATE INDEX &GEXADMIN..ftproducthbin_product_bin ON &GEXADMIN..ft_product_hbin (product_name,bin_no);
...
CREATE INDEX &GEXADMIN..ftproductsbin_product_bin ON &GEXADMIN..ft_product_sbin (product_name,bin_no);
...
CREATE INDEX &GEXADMIN..ftlot_lot ON &GEXADMIN..ft_lot (lot_id);
CREATE INDEX &GEXADMIN..ftlot_product_lot ON &GEXADMIN..ft_lot (product_name,lot_id);
...
CREATE INDEX &GEXADMIN..ftlothbin_lot ON &GEXADMIN..ft_lot_hbin (lot_id);
...
CREATE INDEX &GEXADMIN..ftlotsbin_lot ON &GEXADMIN..ft_lot_sbin (lot_id);
...
CREATE INDEX &GEXADMIN..ftsplitlot_lot ON &GEXADMIN..ft_splitlot (lot_id) LOCAL COMPRESS;
CREATE INDEX &GEXADMIN..ftsplitlot_startt ON &GEXADMIN..ft_splitlot (start_t) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftpartssamp_splitlot_site ON &GEXADMIN..ft_parts_stats_samples (splitlot_id, site_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftpartssum_splitlot_site ON &GEXADMIN..ft_parts_stats_summary (splitlot_id, site_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..fthbin_splitlot ON &GEXADMIN..ft_hbin (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..fthbinsamp_splitlot_site_hbin ON &GEXADMIN..ft_hbin_stats_samples (splitlot_id, site_no, hbin_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..fthbinsum_splitlot_site_hbin ON &GEXADMIN..ft_hbin_stats_summary (splitlot_id, site_no, hbin_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftsbin_splitlot ON &GEXADMIN..ft_sbin (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftsbinsamp_splitlot_site_sbin ON &GEXADMIN..ft_sbin_stats_samples (splitlot_id, site_no, sbin_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftsbinsum_splitlot_site_sbin ON &GEXADMIN..ft_sbin_stats_summary (splitlot_id, site_no, sbin_no) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftrun_splitlot ON &GEXADMIN..ft_run (splitlot_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftptestinfo_splitlot_ptest ON &GEXADMIN..ft_ptest_info (splitlot_id,ptest_info_id) LOCAL COMPRESS; 
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._ft_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..ftptestlimits_splitlot_ptest ON &GEXADMIN..ft_ptest_limits (splitlot_id,ptest_info_id) LOCAL COMPRESS; 
...
CREATE INDEX &GEXADMIN..ftptestresults_splitlot_ptest ON &GEXADMIN..ft_ptest_results (splitlot_id, ptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._ft_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..ftptestsamp_splitlot_ptest ON &GEXADMIN..ft_ptest_stats_samples (splitlot_id, ptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._ft_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..ftptestsum_splitlot_ptest ON &GEXADMIN..ft_ptest_stats_summary (splitlot_id, ptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftmptestinfo_splitlot_mptest ON &GEXADMIN..ft_mptest_info (splitlot_id,mptest_info_id) LOCAL COMPRESS; 
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._ft_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..ftmptestlimits_splitlot_mptest ON &GEXADMIN..ft_mptest_limits (splitlot_id,mptest_info_id) LOCAL COMPRESS; 
...
CREATE INDEX &GEXADMIN..ftmptestresults_splitlot_mptes ON &GEXADMIN..ft_mptest_results (splitlot_id, mptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._ft_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..ftmptestsamp_splitlot_mptest ON &GEXADMIN..ft_mptest_stats_samples (splitlot_id, mptest_info_id) LOCAL COMPRESS;
...
PARTITION BY RANGE (splitlot_id) 
(PARTITION FIRSTPART VALUES LESS THAN (MAXVALUE) TABLESPACE &GEXADMIN._ft_s PCTFREE 5 PCTUSED 80 &LOGGINGMODE. COMPRESS);
CREATE INDEX &GEXADMIN..ftmptestsum_splitlot_mptest ON &GEXADMIN..ft_mptest_stats_summary (splitlot_id, mptest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftftestinfo_splitlot_ftest ON &GEXADMIN..ft_ftest_info (splitlot_id,ftest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftftestresults_splitlot_ftest ON &GEXADMIN..ft_ftest_results (splitlot_id, ftest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftftestsamp_splitlot_ftest ON &GEXADMIN..ft_ftest_stats_samples (splitlot_id, ftest_info_id) LOCAL COMPRESS;
...
CREATE INDEX &GEXADMIN..ftftestsum_splitlot_ftest ON &GEXADMIN..ft_ftest_stats_summary (splitlot_id, ftest_info_id) LOCAL COMPRESS;
...
--
-- Procedure et_custom_incremental_update
--

CREATE PROCEDURE  &GEXADMIN..et_custom_incremental_update
(
	 Splitlot IN NUMBER,
...
--
-- Procedure wt_custom_incremental_update
--

CREATE PROCEDURE &GEXADMIN..wt_custom_incremental_update
(
	 Splitlot IN NUMBER,
	 IncrementalKeyword IN VARCHAR2,
	 Message OUT VARCHAR2,
...
--
-- Procedure ft_custom_incremental_update
--

CREATE PROCEDURE &GEXADMIN..ft_custom_incremental_update
(
	 Splitlot IN NUMBER,
	 IncrementalKeyword IN VARCHAR2,
	 Message OUT VARCHAR2,
