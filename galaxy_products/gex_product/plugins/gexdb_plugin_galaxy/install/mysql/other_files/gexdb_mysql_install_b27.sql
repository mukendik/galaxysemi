...
INSERT INTO global_info VALUES ('GEXDB V3.03 B27 (MySQL)', 303, 27, 0, 'UPDATING_CONSOLIDATION_TREE|UPDATING_CONSOLIDATION_TRIGGERS|UPDATING_CONSOLIDATION_TABLES|UPDATING_CONSOLIDATION_PROCEDURES|UPDATING_INDEXES', NULL);
...
CREATE TABLE wt_lot (
  ...
  nb_parts_good mediumint(8) NOT NULL DEFAULT '0',
  flags binary(2) DEFAULT NULL,
  PRIMARY KEY (lot_id,tracking_lot_id)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ;
...
CREATE TABLE wt_mptest_results (
  ...
  flags binary(1) NOT NULL DEFAULT '\0',
  value float DEFAULT NULL,
  tpin_pmrindex smallint(6) unsigned DEFAULT NULL,
...
CREATE TABLE ft_pin_map (
  splitlot_id int(10) unsigned NOT NULL,
  tpin_pmrindex smallint(6) unsigned NOT NULL,
