...
INSERT INTO global_info VALUES ('GEXDB V4.03 B33 (MySQL)', 403, 33, 0, 'UPDATING_CONSOLIDATION_TREE|UPDATING_CONSOLIDATION_TRIGGERS|UPDATING_CONSOLIDATION_TABLES|UPDATING_CONSOLIDATION_PROCEDURES|UPDATING_INDEXES', NULL);
...
CREATE TABLE et_wafer_info (
  ...
  wafer_nb tinyint(3) unsigned DEFAULT NULL,
  site_config varchar(255) DEFAULT NULL,
  PRIMARY KEY (lot_id,wafer_id,product_name)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ;
...
CREATE TABLE wt_lot (
  ...
  nb_parts_good mediumint(8) NOT NULL DEFAULT '0',
  flags binary(2) DEFAULT NULL,
  PRIMARY KEY (lot_id,tracking_lot_id,product_name)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ;
...
CREATE TABLE ft_sublot_info (
 ...
 consolidation_status varchar(255) DEFAULT NULL,
 consolidation_ref_date datetime DEFAULT NULL,
 PRIMARY KEY (lot_id,sublot_id,product_name)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ;
--
