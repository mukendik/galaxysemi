...
INSERT INTO GLOBAL_INFO VALUES('GEXDB V1.0 B7', 10, 7, 0);
...
-- ELECTRICAL TEST
--
DROP TABLE IF EXISTS et_syl_set;
CREATE TABLE et_syl_set (
  SYL_ID				int(10) unsigned	NOT NULL,
  PRODUCT_ID			varchar(255)		NOT NULL,
  CREATION_DATE			datetime			NOT NULL,
  FILE_NAME				varchar(255)		DEFAULT NULL,
  USER_COMMENT			varchar(255)		DEFAULT NULL,
  LL					smallint(5)			NOT NULL DEFAULT -1,
  HL					smallint(5)			NOT NULL DEFAULT -1,
  PRIMARY KEY  (SYL_ID)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;

DROP TABLE IF EXISTS et_sbl_set;
CREATE TABLE et_sbl_set (
  SBL_ID				int(10) unsigned	NOT NULL,
  PRODUCT_ID			varchar(255)		NOT NULL,
  CREATION_DATE			datetime			NOT NULL,
  FILE_NAME				varchar(255)		DEFAULT NULL,
  USER_COMMENT			varchar(255)		DEFAULT NULL,
...
CREATE TABLE et_sbl (
  SBL_ID				int(10) unsigned		NOT NULL,
  BIN_NO				smallint(3) unsigned	NOT NULL,
...
CREATE TABLE et_splitlot (
  ...
  SYL_ID			int(10) unsigned		DEFAULT '0',
  SBL_ID			int(10) unsigned		DEFAULT '0',
...
-- WAFER SORT
--
DROP TABLE IF EXISTS wt_syl_set;
CREATE TABLE wt_syl_set (
  SYL_ID				int(10) unsigned	NOT NULL,
  PRODUCT_ID			varchar(255)		NOT NULL,
  CREATION_DATE			datetime			NOT NULL,
  FILE_NAME				varchar(255)		DEFAULT NULL,
...
DROP TABLE IF EXISTS wt_sbl_set;
CREATE TABLE wt_sbl_set (
  SBL_ID				int(10) unsigned	NOT NULL,
  PRODUCT_ID			varchar(255)		NOT NULL,
  CREATION_DATE			datetime			NOT NULL,
  FILE_NAME				varchar(255)		DEFAULT NULL,
...
-- FINAL TEST
--
DROP TABLE IF EXISTS ft_syl_set;
CREATE TABLE ft_syl_set (
  SYL_ID				int(10) unsigned	NOT NULL,
  PRODUCT_ID			varchar(255)		NOT NULL,
  CREATION_DATE			datetime			NOT NULL,
  FILE_NAME				varchar(255)		DEFAULT NULL,
...
DROP TABLE IF EXISTS ft_sbl_set;
CREATE TABLE ft_sbl_set (
  SBL_ID				int(10) unsigned	NOT NULL,
  PRODUCT_ID			varchar(255)		NOT NULL,
  CREATION_DATE			datetime			NOT NULL,
  FILE_NAME				varchar(255)		DEFAULT NULL,
