...
SET GexServerStatus=
IF NOT EXIST "gexdb_mysql_install_b6.sql"      SET ErrorMessage= cannot find gexdb_mysql_install_b6.sql in %CD% & goto Error
...
:DataBaseCreation
SET GexDbSql=gexdb_mysql_install_b6.sql
