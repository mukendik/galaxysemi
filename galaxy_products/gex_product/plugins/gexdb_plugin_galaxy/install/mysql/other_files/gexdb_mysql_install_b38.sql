...
INSERT INTO global_info VALUES ('GEXDB V5.02 B38 (MySQL)', 502, 38, 0, 'UPDATING_CONSOLIDATION_TREE|UPDATING_CONSOLIDATION_TRIGGERS|UPDATING_CONSOLIDATION_TABLES|UPDATING_CONSOLIDATION_PROCEDURES|UPDATING_INDEXES', NULL);
...
CREATE TABLE et_ptest_results (
  ...
  testseq smallint(5) unsigned NOT NULL,
...
CREATE TABLE et_lot_sbin (
  ...
  sbin_no smallint(5) unsigned NOT NULL,
...
CREATE TABLE ft_lot_hbin (
  lot_id varchar(255) NOT NULL,
  product_name varchar(255) NOT NULL,
  hbin_no smallint(5) unsigned NOT NULL,
...
CREATE TABLE wt_run (
  splitlot_id int(10) unsigned NOT NULL,
  run_id mediumint(7) unsigned NOT NULL,
  site_no smallint(5) NOT NULL DEFAULT '1',
  part_id varchar(255) DEFAULT NULL,
  part_x smallint(6) DEFAULT NULL,
  part_y smallint(6) DEFAULT NULL,
...
CREATE TABLE incremental_update (
  ...
  processed_splitlots int(9) NOT NULL DEFAULT '0',
  remaining_splitlots int(9) NOT NULL DEFAULT '0',
  status varchar(255) DEFAULT 'DISABLED',
  frequency varchar(255) DEFAULT '*/10 * * * *',
  max_items int(9) DEFAULT 10,
...
CREATE TABLE ft_mptest_info (
  ...
  tnum int(10) unsigned NOT NULL,
  tname varchar(255) NOT NULL DEFAULT '',
  tpin_arrayindex smallint(6) unsigned NOT NULL,
  units varchar(255) NOT NULL DEFAULT '',
  flags binary(1) NOT NULL DEFAULT '\0',
  ll float DEFAULT NULL,
  hl float DEFAULT NULL,
