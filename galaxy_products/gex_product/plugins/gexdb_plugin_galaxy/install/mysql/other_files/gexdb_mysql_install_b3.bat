...
SET GexServerStatus=
IF NOT EXIST "gexdb_mysql_install_b3.sql"      SET ErrorMessage= cannot find gexdb_mysql_install_b3.sql in %CD% & goto Error
...
:DataBaseCreation
SET GexDbSql=gexdb_mysql_install_b3.sql
