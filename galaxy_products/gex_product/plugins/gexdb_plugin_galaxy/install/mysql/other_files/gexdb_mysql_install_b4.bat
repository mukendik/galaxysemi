...
SET GexServerStatus=
IF NOT EXIST "gexdb_mysql_install_b4.sql"      SET ErrorMessage= cannot find gexdb_mysql_install_b4.sql in %CD% & goto Error
...
:DataBaseCreation
SET GexDbSql=gexdb_mysql_install_b4.sql
