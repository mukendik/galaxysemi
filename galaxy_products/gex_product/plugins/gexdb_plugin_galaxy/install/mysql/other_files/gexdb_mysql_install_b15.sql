...
INSERT INTO global_info VALUES ('GEXDB V2.00 B15 (MySQL)', 200, 15, 0);
...
CREATE TABLE incremental_update (
  ...
  db_version_build smallint(5) NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_dtr (
  ...
  KEY etdtr_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_hbin (
  ...
  KEY ethbin_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_product_hbin (
  ...
  KEY etproducthbin_product_bin (product_name,bin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_product_sbin (
  ...
  bin_cat char(1) DEFAULT NULL,
  nb_parts bigint(20) NOT NULL DEFAULT 0,
  KEY etproductsbin_product_bin (product_name,bin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_ptest_info (
  ...
  KEY etptestinfo_splitlot_ptest (splitlot_id,ptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_ptest_results (
  ...
  KEY etptestresults_splitlot_ptest (splitlot_id,ptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_run (
  ...
  KEY etrun_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_sbin (
  ...
  sbin_cat char(1) DEFAULT NULL,
  bin_count mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY etsbin_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_wafer_hbin (
  ...
  hbin_cat char(1) DEFAULT NULL,
  nb_parts mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY etwaferhbin_lot_wafer (lot_id,wafer_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_wafer_info (
  ...
  wafer_nb tinyint(3) unsigned DEFAULT NULL,
  site_config varchar(255) DEFAULT NULL,
  KEY etwaferinfo_lot_wafer (lot_id,wafer_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE et_wafer_sbin (
  ...
  sbin_cat char(1) DEFAULT NULL,
  nb_parts mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY etwafersbin_lot_wafer (lot_id,wafer_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_dtr (
  ...
  dtr_type varchar(255) NOT NULL,
  dtr_text varchar(255) NOT NULL DEFAULT '',
  KEY ftdtr_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_die_tracking (
  ...
  KEY ftmultidietracking_fttl (ft_tracking_lot_id),
  KEY ftmultidietracking_wttl (wt_tracking_lot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_ftest_info (
  ...
  tname varchar(255) NOT NULL DEFAULT '',
  testseq smallint(5) unsigned DEFAULT NULL,
  KEY ftftestinfo_splitlot_ftest (splitlot_id,ftest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_ftest_results (
  ...
  KEY ftftestresults_splitlot_ftest (splitlot_id,ftest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_hbin (
  ...
  hbin_name varchar(255) NOT NULL DEFAULT '',
  hbin_cat char(1) DEFAULT NULL,
  KEY fthbin_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_hbin_stats_samples (
  ...
  hbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  nb_parts mediumint(8) NOT NULL DEFAULT 0,
  KEY fthbinsamp_splitlot_site_hbin (splitlot_id,site_no,hbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_hbin_stats_summary (
  ...
  hbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  bin_count mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY fthbinsum_splitlot_site_hbin (splitlot_id,site_no,hbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_lot (
  ...
  nb_parts_good mediumint(8) NOT NULL DEFAULT 0,
  flags binary(2) DEFAULT NULL,
  KEY ftlot_lot (lot_id),
  KEY ftlot_product_lot (product_name,lot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_mptest_info (
  ...
  ll_scal tinyint(3) DEFAULT NULL,
  hl_scal tinyint(3) DEFAULT NULL,
  KEY ftmptestinfo_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_mptest_limits (
  ...
  LL float DEFAULT NULL,
  HL float DEFAULT NULL,
  KEY ftmptestlimits_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_mptest_results (
  ...
  KEY ftmptestresults_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_mptest_stats_samples (
  ...
  sum float DEFAULT NULL,
  square_sum float DEFAULT NULL,
  KEY ftmptestsamp_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_mptest_stats_summary (
  ...
  square_sum float DEFAULT NULL,
  ttime int(10) unsigned DEFAULT NULL,
  KEY ftmptestsum_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_parts_stats_samples (
  ...
  nb_parts mediumint(8) NOT NULL DEFAULT 0,
  nb_parts_good mediumint(8) NOT NULL DEFAULT 0,
  KEY ftpartssamp_splitlot_site (splitlot_id,site_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_parts_stats_summary (
  ...
  KEY ftpartssum_splitlot_site (splitlot_id,site_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_product_hbin (
  ...
  bin_cat char(1) DEFAULT NULL,
  nb_parts bigint(20) NOT NULL DEFAULT 0,
  KEY ftproducthbin_product_bin (product_name,bin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_product_sbin (
  ...
  bin_cat char(1) DEFAULT NULL,
  nb_parts bigint(20) NOT NULL DEFAULT 0,
  KEY ftproductsbin_product_bin (product_name,bin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_ptest_info (
  ...
  ll_scal tinyint(3) DEFAULT NULL,
  hl_scal tinyint(3) DEFAULT NULL,
  KEY ftptestinfo_splitlot_ptest (splitlot_id,ptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_ptest_results (
  ...
  flags binary(1) NOT NULL DEFAULT '\0',
  `value` float DEFAULT NULL,
  KEY ftptestresults_splitlot_ptest (splitlot_id,ptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_run (
  ...
  wafer_id varchar(255) DEFAULT NULL,
  part_txt varchar(255) DEFAULT NULL,
  KEY ftrun_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_sbin (
  ...
  sbin_name varchar(255) NOT NULL DEFAULT '',
  sbin_cat char(1) DEFAULT NULL,
  KEY ftsbin_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_sbin_stats_samples (
  ...
  sbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  nb_parts mediumint(8) NOT NULL DEFAULT 0,
  KEY ftsbinsamp_splitlot_site_sbin (splitlot_id,site_no,sbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE ft_sbin_stats_summary (
  ...
  sbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  bin_count mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY ftsbinsum_splitlot_site_sbin (splitlot_id,site_no,sbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_dtr (
  ...
  dtr_type varchar(255) NOT NULL,
  dtr_text varchar(255) NOT NULL DEFAULT '',
  KEY wtdtr_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_ftest_info (
  ...
  tname varchar(255) NOT NULL DEFAULT '',
  testseq smallint(5) unsigned DEFAULT NULL,
  KEY wtftestinfo_splitlot_ftest (splitlot_id,ftest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_ftest_results (
  ...
  vect_nam varchar(255) NOT NULL DEFAULT '',
  vect_off smallint(6) DEFAULT NULL,
  KEY wtftestresults_splitlot_ftest (splitlot_id,ftest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_hbin (
  ...
  hbin_name varchar(255) NOT NULL DEFAULT '',
  hbin_cat char(1) DEFAULT NULL,
  KEY wthbin_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_hbin_stats_samples (
  ...
  hbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  nb_parts mediumint(8) NOT NULL DEFAULT 0,
  KEY wthbinsamp_splitlot_site_hbin (splitlot_id,site_no,hbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_hbin_stats_summary (
  ...
  hbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  bin_count mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY wthbinsum_splitlot_site_hbin (splitlot_id,site_no,hbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_lot (
  ...
  nb_parts_good mediumint(8) NOT NULL DEFAULT 0,
  flags binary(2) DEFAULT NULL,
  KEY wtlot_lot (lot_id),
  KEY wtlot_product_lot (product_name,lot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_mptest_info (
  ...
  ll_scal tinyint(3) DEFAULT NULL,
  hl_scal tinyint(3) DEFAULT NULL,
  KEY wtmptestinfo_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_mptest_limits (
  ...
  LL float DEFAULT NULL,
  HL float DEFAULT NULL,
  KEY wtmptestlimits_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_mptest_results (
  ...
  `value` float DEFAULT NULL,
  tpin_pmrindex smallint(6) DEFAULT NULL,
  KEY wtmptestresults_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_mptest_stats_samples (
  ...
  sum float DEFAULT NULL,
  square_sum float DEFAULT NULL,
  KEY wtmptestsamp_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_mptest_stats_summary (
  ...
  square_sum float DEFAULT NULL,
  ttime int(10) unsigned DEFAULT NULL,
  KEY wtmptestsum_splitlot_mptest (splitlot_id,mptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_parts_stats_samples (
  ...
  nb_parts mediumint(8) NOT NULL DEFAULT 0,
  nb_parts_good mediumint(8) NOT NULL DEFAULT 0,
  KEY wtpartssamp_splitlot_site (splitlot_id,site_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_parts_stats_summary (
  ...
  nb_good mediumint(8) DEFAULT NULL,
  nb_rtst mediumint(8) DEFAULT NULL,
  KEY wtpartssum_splitlot_site (splitlot_id,site_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_product_hbin (
  ...
  bin_cat char(1) DEFAULT NULL,
  nb_parts bigint(20) NOT NULL DEFAULT 0,
  KEY wtproducthbin_product_bin (product_name,bin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_product_sbin (
  ...
  bin_cat char(1) DEFAULT NULL,
  nb_parts bigint(20) NOT NULL DEFAULT 0,
  KEY wtproductsbin_product_bin (product_name,bin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_ptest_results (
  ...
  flags binary(1) NOT NULL DEFAULT '\0',
  `value` float DEFAULT NULL,
  KEY wtptestresults_splitlot_ptest (splitlot_id,ptest_info_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_run (
  ...
  retest_index tinyint(3) unsigned NOT NULL DEFAULT 0,
  part_txt varchar(255) DEFAULT NULL,
  KEY wtrun_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_sbin (
  ...
  sbin_name varchar(255) NOT NULL DEFAULT '',
  sbin_cat char(1) DEFAULT NULL,
  KEY wtsbin_splitlot (splitlot_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_sbin_stats_samples (
  ...
  sbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  nb_parts mediumint(8) NOT NULL DEFAULT 0,
  KEY wtsbinsamp_splitlot_site_sbin (splitlot_id,site_no,sbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_sbin_stats_summary (
  ...
  sbin_no smallint(5) unsigned NOT NULL DEFAULT 0,
  bin_count mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY wtsbinsum_splitlot_site_sbin (splitlot_id,site_no,sbin_no)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_wafer_hbin (
  ...
  hbin_cat char(1) DEFAULT NULL,
  nb_parts mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY wtwaferhbin_lot_wafer (lot_id,wafer_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_wafer_info (
  ...
  flags binary(2) DEFAULT NULL,
  wafer_nb tinyint(3) unsigned DEFAULT NULL,
  KEY wtwaferinfo_wafer (wafer_id),
  KEY wtwaferinfo_lot_wafer (lot_id,wafer_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
...
CREATE TABLE wt_wafer_sbin (
  ...
  sbin_cat char(1) DEFAULT NULL,
  nb_parts mediumint(8) unsigned NOT NULL DEFAULT 0,
  KEY wtwafersbin_lot_wafer (lot_id,wafer_id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=1;
