...
-- START UPDATE
-- ---------------------------------------------------------
CALL is_compatible_version(50, @status, @message);
CALL start_update('GEXDB V5.04 B51 (MySQL)', 504, 51, @status, @message);
...
CALL change_column(Database(), 'wt_mptest_info', 'tpin_arrayindex', 'mediumint NOT NULL', @status, @message);

CALL change_column(Database(), 'ft_mptest_info', 'tpin_arrayindex', 'mediumint NOT NULL', @status, @message);
