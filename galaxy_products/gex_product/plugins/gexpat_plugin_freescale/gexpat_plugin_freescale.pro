# -------------------------------------------------
# Project created by QtCreator 2009-06-05T10:38:21
# -------------------------------------------------
DESTDIR = $(DEVDIR)/galaxy_products/gex_product/plugins/lib
TARGET = gexpat_plugin_freescale
TEMPLATE = lib
...
SOURCES += sources/gexpat_plugin_freescale.cpp
HEADERS += sources/gexpat_plugin_freescale.h
