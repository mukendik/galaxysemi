...
static ZString buildCsv(ZString val, char type, int frac, char hyph)
{
...
void ZCslInitLib_String(ZCsl* aCsl)
{
   ZFUNCTRACE_DEVELOP("ZCslInitLib(aCsl)");
   ZString iFile("StringLib");
   ZString init(ZString(
      "const strVersion = '3.00';\n"
...
void ZCslCleanupLib_String(ZCsl* /*aCsl*/)
{
