Quantix GTL-IGXL library

Purpose : 
This library is needed in order for a Microsoft Excel/VisualBasic 2003 (i.e. usully IG-XL version 5.10.55) test program to interact with the GTL solution of Quantix.
