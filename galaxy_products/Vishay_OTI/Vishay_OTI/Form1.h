...
#define DISABLE_PROGRAM 0  // Set to 1 to check for an expiration date
						   // Set to 0 to bypass expiration validation
#include "profile.h"
...
namespace Vishay_OTI {
	...
	static Hashtable ^hashBinNames = gcnew Hashtable(200);  // Bin names to be saved in hash table
	//
...
private: System::Windows::Forms::DataGridViewTextBoxColumn^  Retestable;
...
private: System::Windows::Forms::DataGridViewTextBoxColumn^  SE_Retestable;
private: System::Windows::Forms::DataGridViewTextBoxColumn^  SE_Bin_Name;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Retestable = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->Bin_Name = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->SE_Retestable = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->SE_Bin_Name = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->dataGridView2->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(8) {this->Test_Family, 
				this->Test_Name, this->Test_Number, this->Mapped_Test, this->Bin_Number, this->Fail_Count, this->Retestable, this->Bin_Name});
			...
			// Retestable
			// 
			this->Retestable->HeaderText = L"Re-testable";
			this->Retestable->Name = L"Retestable";
			this->Retestable->ReadOnly = true;
			this->Retestable->Visible = false;
			// 
			// Bin_Name
			// 
			this->Bin_Name->HeaderText = L"Bin_Name";
			this->Bin_Name->Name = L"Bin_Name";
			this->Bin_Name->ReadOnly = true;
			this->Bin_Name->Visible = false;
			// 
			// tabPage2
			// 
			...
			this->dataGridView3->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(8) {this->SE_Test_Family, 
				this->SE_Test_Name, this->SE_Test_Number, this->SE_Mapped_Test, this->SE_Bin_Number, this->SE_Fail_Count, this->SE_Retestable, 
				this->SE_Bin_Name});
			...
			// SE_Retestable
			// 
			this->SE_Retestable->HeaderText = L"Re-testable";
			this->SE_Retestable->Name = L"SE_Retestable";
			this->SE_Retestable->ReadOnly = true;
			this->SE_Retestable->Visible = false;
			// 
			// SE_Bin_Name
			// 
			this->SE_Bin_Name->HeaderText = L"Bin_Name";
			this->SE_Bin_Name->Name = L"SE_Bin_Name";
			this->SE_Bin_Name->ReadOnly = true;
			this->SE_Bin_Name->Visible = false;
			// 
			// SE_failCount
			// 
			...
			this->comboBox1->Validating += gcnew System::ComponentModel::CancelEventHandler(this, &Form1::comboBox1_Validating);
			this->comboBox1->Validated += gcnew System::EventHandler(this, &Form1::comboBox1_Validated);
			...
			this->totalParts->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Form1::totalParts_MouseDown);
			this->totalParts->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &Form1::totalParts_KeyPress);
			this->totalParts->Enter += gcnew System::EventHandler(this, &Form1::totalParts_Enter);
			// 
			// label2
			// 
			...
			// TesterComboBox
			// 
			this->TesterComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// IF89_ComboBox
			// 
			this->IF89_ComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// UIS_ComboBox
			// 
			this->UIS_ComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// TR_ComboBox
			// 
			this->TR_ComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// LCR_ComboBox
			// 
			this->LCR_ComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// TR_2ComboBox
			// 
			this->TR_2ComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// UIS_2ComboBox
			// 
			this->UIS_2ComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// LCR_2ComboBox
			// 
			this->LCR_2ComboBox->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			...
			// this->Text = L"Vishay OTI     Version 1.1";  Bar code update
			// this->Text = L"Vishay OTI     Version 1.2";	Add FT_PROMIS_PACKAGE to MIR record
			this->Text = L"Vishay OTI     Version 1.3";		// Add single die DTR record
...
private: System::Void comboBox1_Validating(System::Object^  sender, System::ComponentModel::CancelEventArgs^  e) 
{
	...
	{ 
		e->Cancel = true;
		MessageBox::Show("The Lot_ID entered is not in the Promis Data File.", 
			"Lot_ID Not Found", MessageBoxButtons::OK, MessageBoxIcon::Error);
		this->comboBox1->Focus();
	}
}

private: System::Void comboBox1_Validated(System::Object^  sender, 
			 System::EventArgs^  e) 
{
...
private: System::Void comboBox1_KeyDown(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) 
{
    ...
    {
		e->Handled = true;
		MessageBox::Show("Canceling input");
		this->comboBox1->SelectedIndex = 0;	
		this->comboBox1->Focus();
    }
}
...
private: System::Void totalParts_KeyPress(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) 
{
	...
	{		
		...
		{
			this->totalParts->Text = "0";
			this->totalParts->SelectAll();
		}
			else if( key != Keys::Back ) 
			{
				MessageBox::Show("Invalid value entered and discarded.", 
					"Data Entry Error", MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
				e->Handled = true;
			}
	}
...
private: System::Void totalParts_Enter(System::Object^  sender, System::EventArgs^  e) 
{
	this->totalParts->SelectAll();		
}

private: System::Void totalParts_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) 
{
	this->totalParts->SelectAll();
}
...
private: void zeroAll()
{
	...
	for (int i = 0; i < intRows2; i++)
		this->dataGridView2->Rows[i]->Cells["Fail_Count"]->Value = "0";
	// Clear Sort Entries
	intRows2 = this->dataGridView3->Rows->Count;
	for (int i = 0; i < intRows2; i++)
		this->dataGridView3->Rows[i]->Cells["SE_Fail_Count"]->Value = "0";
...
private: String^ getStrINIpath()
{
	...
	String ^ strINIpath = Environment::GetEnvironmentVariable("OTI_INI_PATH");
	return strINIpath;
}
			 ...
			 System::EventArgs^  e) 
{
	...
	// Expiration Date is August 22, 2009 (12 Noon)
	DateTime dateToExpire = DateTime(2009, 8, 22, 12, 0, 0); 
	...
	{		
		...
		String^ reTestInstance = setRetestInstance(nowTestInstance); // Set Retest instance
		strTriggerFile = buildFileName(strLot_ID, reTestInstance);
		writeTriggerFile(strTriggerPath + strTriggerFile, goodParts, reTestInstance);
...
private: String^ buildFileName(String^ strLot_ID, String^ reTestInstance)
{
	String^ fileNameTrg;
	// Construct trigger file name
	// fileNameTrg = strLot_ID + "_" + GALdataType + "_" + reTestInstance+ "_" + 
	// 	reTestBinList + GALfileType;
	fileNameTrg = strLot_ID + "_" + GALdataType + "_" + reTestInstance + GALfileType;
	return fileNameTrg; 
}

private: void writeTriggerFile(String^ strTriggerFile, int goodParts, String^ reTestInstance)
{
	String^ str;
	...
	// strPackage placed in ROM Code ID field
	str = "MIR:" + strLot_ID_NoSplit + "|" + strGeom_Name + "|||" + strEquipment_ID + "|" 
		...
		+ "||" + strProduct_ID + "||||||||" + strPackage + "||";
	sw->WriteLine(str);
	//
	// RDR Record to store all re-testable bin numbers
	// e.g., RDR:3,15,7,2,4
	
	if ( reTestInstance != "0" ) // Check to see if this is a retest 
	{
		// Final Tests and Sort Entries
		buildRDRrecord(sw);
	}
	//
	...
	while ( enum1->MoveNext() )
	{
		...
		if (Count != "0")
		{		
			str = "SBR:||" + Bin + "|" + Count + "|F|" + hashBinNames[Bin]->ToString();
			sw->WriteLine(str);
		}
	}
	//
	//	Die-tracking DTR Records (1 field per die)
	//	e.g., DTR:<cmd> die-tracking die=1;wafer_product=PARF20FFOA;wafer_lot=X16M139.9
	//	1S = single die, 2D = 2 dies, 2P = 2 dies, 3T = 3 dies, 4P = 4 dies
	//
	//  Write DTR for die 1	
	//
		str = "DTR:<cmd> die-tracking die=1;wafer_product=" + strGeom_Name + 
			";wafer_lot=" + getLotID(strLot_ID) + ";wafer_sublot=" + strLot_ID;
		sw->WriteLine(str);								
		if (strPkg_Type != "1S")			// No more DTR records generated for single die
		{
			//
			// Multi-die wafer has at least 2 dies, write the second DTR record
			//
			str = "DTR:<cmd> die-tracking die=2;wafer_product=" + strGeom_Name_2 + 
				";wafer_lot=" + getLotID(strLot_ID_2) + ";wafer_sublot=" + strLot_ID_2;
			sw->WriteLine(str);								// Write DTR for die 2

			if (strPkg_Type == "3T" || strPkg_Type == "4P")	// Does this wafer have more than 2 dies?
			{
				str = "DTR:<cmd> die-tracking die=3;wafer_product=" + strGeom_Name_3 + 
					";wafer_lot=" + getLotID(strLot_ID_3) + ";wafer_sublot=" + strLot_ID_3;
				sw->WriteLine(str);							// Write DTR for die 3
				if (strPkg_Type == "4P")					// Does this wafer have 4 dies
				{
					str = "DTR:<cmd> die-tracking die=4;wafer_product=" + strGeom_Name_4 + 
						";wafer_lot=" + getLotID(strLot_ID_4) + ";wafer_sublot=" + strLot_ID_4;
...
private: String^ getLotID(String^ SublotID)
{
	String^ strValue;
	int ind = SublotID->IndexOf(".");
	if (ind < 0)
		strValue = SublotID;
	else
		strValue = SublotID->Substring(0,ind);
	return strValue;
}

private: void buildRDRrecord(StreamWriter^ sw)
{
	String^ str;
	String^ strGrid;
	String^ strTemp;
	...
	array<Char>^chars =  {','};
	ArrayList^ bins = gcnew ArrayList(200);  // Retestable bins
	
	for (int i = 0; i < 2; i++)  // Process Final Test and Sort Entry bins
	{
		if (i == 0)
		{
		...
		for (int jrow = 0; jrow < dataGridView->Rows->Count; jrow++)
		{
			String^ strBin = dataGridView->Rows[jrow]->Cells[strGrid + "Retestable"]->
				Value->ToString();
			if ( strBin == "1" )  // Test for re-testable bin
			{
				strTemp = dataGridView->Rows[jrow]->Cells[strGrid + "Bin_Number"]->
					Value->ToString();
				if (!bins->Contains(strTemp)) // Test for duplicate  
				{
					bins->Add(strTemp);
					strTemp = strTemp + ",";
					if ((str->Length + strTemp->Length) > 80)
					{
						sw->WriteLine(str);			// Write the record and begin continuation line
						str = " " + strTemp;
					}
					else
						str = str + strTemp;					 
	...
	sw->WriteLine(str->TrimEnd(chars));  // Write last of the record and remove last comma
	return;
}
			 ...
			 DataGridView^ dataGridView)
{
	...
	{	
		...
		if (str->IndexOfAny(chrComment) != 0 && String::IsNullOrEmpty(str) == false) 
		{
			...
			int colCnt = dataGridView->ColumnCount;	
			for (int i = 1; i < colCnt - 2; i++) // Sets first 5 DataGridView columns
			{
			...
			if (rawFT->Length < 9)		// Re-testable flag available?
				s[colCnt-2] = "";
			else
				s[colCnt-2] = rawFT[8];		
			s[colCnt-3] = "0";			// Fail Count
			// Set Bin Name
			if (testType == strTestType[0])
				s[colCnt-1] = rawFT[7]; // Column H of FinalTest.csv file
			else
				s[colCnt-1] = rawFT[2]; // Column C of SortEntries.csv file
			Bin_Number = s[4];
			Bin_Name = s[colCnt-1];
			dataGridView->Rows->Add(s);
			if (!hashBinNames->Contains(Bin_Number))
				hashBinNames->Add(Bin_Number, Bin_Name);
		}
	}	
